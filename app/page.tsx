          ...
          <div className="space-y-8 max-w-6xl mx-auto px-6 py-12 md:py-20">
            ...
            <div className="space-y-4 max-w-3xl">
              <h1 className="text-4xl md:text-5xl font-semibold tracking-tight text-slate-50">
                Développeur web full‑stack — des sites et applications de bout en bout.
              </h1>

              <p className="text-base md:text-lg text-slate-200/90 leading-relaxed">
                Je conçois et développe des expériences modernes, accessibles et performantes, du front‑end au back‑end. J’aide les entreprises et les créateurs à présenter leur activité avec une identité solide, une interface soignée et un fonctionnement fiable.
              </p>
            </div>
